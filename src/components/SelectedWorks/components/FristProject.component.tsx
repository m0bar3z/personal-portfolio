...
const FirstProject: FC = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-8 h-80 mb-16 mt-16'>
      {useMemo(
        () => (
      ...
      <div className='flex flex-col justify-between w-full gap-2 md:gap-8 '>
        <h2 className='text-gray-100 text-xl md:text-3xl font-bold text-center'>My First Project!</h2>
        <h4 className='text-gray-100 text-lg md:text-2xl font-bold text-center'>
          <HoverText
            staticText='Transforming ideas into delightful experiences with React wizardry.'
            hoverText={hoverText}
          />
        </h4>
...
export default memo(FirstProject);
